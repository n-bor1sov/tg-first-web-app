  ...
  return (
    <div className={"challenge"}>
      <div className={"challenge-left-module"}>
        <img
          src={images[data.content.challenge.info.id]}
          alt="Сhallenge reward"
        />
        <div className="rewards">
          <div className={"points"}>
            {data.content.challenge.info.points} points
          </div>
          <div className={"gems-ch"}>
            {data.content.challenge.info.gems} gems
          </div>
        </div>
      </div>
      <div className={"challenge-center-module"}>
        <ProgressBar
          ...
          description={shortDescription(
            data.content.challenge.info?.description,
          )}
        />
      </div>
      <div className="challenge-right-module">
        <Button onClick={data.clickHandler}>Details</Button>
      </div>
    </div>
  );
};
